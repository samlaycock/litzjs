...
export const LITZ_SERVER_RUNTIME_OPTIONS_ID = "virtual:litzjs:server-runtime-options";
export const RESOLVED_LITZ_SERVER_RUNTIME_OPTIONS_ID = "\0virtual:litzjs:server-runtime-options";
