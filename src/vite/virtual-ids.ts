...
export const SERVER_MANIFEST_ID = "virtual:litzjs:server-manifest";
export const RESOLVED_SERVER_MANIFEST_ID = "\0virtual:litzjs:server-manifest";
export const BASE_ID = "virtual:litzjs:base";
export const RESOLVED_BASE_ID = "\0virtual:litzjs:base";
