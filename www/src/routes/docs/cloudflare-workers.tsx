  ...
  return (
    <>
      ...
      <ul className="text-neutral-400 space-y-1 list-disc list-inside mb-8">
        <li>
          build client assets to <code className="text-sky-400">dist/public</code>
        </li>
        <li>
  ...
  "assets": {
    ...
    "run_worker_first": ["/_litzjs/*", "/api/*"]
        ...
        <p className="text-neutral-400 mt-4 mb-4">
          ...
          <code className="text-sky-400">dist/public</code> matches the generated output and keeps
...
wrangler deploy`}
      ...
      <section className="mb-12">
        ...
        <p className="text-neutral-400 mb-4">
          ...
          to <code className="text-sky-400">dist/public</code>.
        </p>
        <p className="text-neutral-400 mb-4">
