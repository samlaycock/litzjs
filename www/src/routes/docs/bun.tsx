  ...
  return (
    <>
      ...
      <p className="text-xl text-neutral-300 mb-8">
        ...
        browser assets from <code className="text-sky-400">dist/client</code>.
      </p>
    ...
    return app.fetch(request);
      ...
      <section className="mb-12">
        ...
        <p className="text-neutral-400 mb-4">
          ...
          <code className="text-sky-400">dist/client</code> and keep Bun responsible for the dynamic
    ...
    "preview": "vite preview"
      ...
      <section className="mb-12">
        ...
        <ul className="text-neutral-400 space-y-1 list-disc list-inside mb-4">
          ...
          <li>
            Browser requests resolve from <code className="text-sky-400">dist/client</code>
          </li>
          <li>
